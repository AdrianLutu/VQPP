...
df_train = pd.read_csv("/home/eduard/Desktop/Research/Adrian/VQPP/GRAM/GRAM/metrics/msrvtt_train.csv")
df_eval = pd.read_csv("/home/eduard/Desktop/Research/Adrian/VQPP/GRAM/GRAM/metrics/msrvtt_val.csv")
df_test = pd.read_csv("/home/eduard/Desktop/Research/Adrian/VQPP/GRAM/GRAM/metrics/msrvtt_test.csv")


df_train = df_train[["Query", "Recall@10"]]
df_eval = df_eval[["Query", "Recall@10"]]
